sc_bases <- list(
  ...
  base_atlanta_complete = list( # Default in R/utils-params
...
sc_atl_others <- list(
  ...
  base_atlanta_complete_alt = list( # Alternate method for ident prob
    part.ident.start = param$prep.start,
...
sc_ident_max <- list(
  ident_max = list( # maximum possible effect (unachievable in practice)
    part.ident.start = param$prep.start,
  ...
  ident_max_test = list( # maximum test (prep effect via LNT)
    part.ident.start = param$prep.start,
    # see "R/z-indent_prob_calib.R"
    part.ident.main.prob = 1,
    part.ident.casl.prob = 1,
  ...
  ident_max_prep = list( # maximum test + prep
    part.ident.start = param$prep.start,
    # see "R/z-indent_prob_calib.R"
    part.ident.main.prob = 1,
    part.ident.casl.prob = 1,
  ...
  ident_max_tx = list( # maximum test + tx (re)init
    part.ident.start = param$prep.start,
    # see "R/z-indent_prob_calib.R"
    part.ident.main.prob = 1,
    part.ident.casl.prob = 1,
