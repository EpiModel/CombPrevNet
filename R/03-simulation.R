...
param <- param_msm(netstats = netstats,
                   epistats = epistats,
                   hiv.test.rate = c(0.0045, 0.00425, 0.00925),
                   hiv.test.late.prob = c(0, 0, 0),
                   tx.init.prob = c(0.1785, 0.190, 0.26),
                   tt.part.supp = c(0.05, 0.05, 0.05),
                   tt.full.supp = c(0.95, 0.95, 0.95),
                   tt.dur.supp = c(0, 0, 0),
                   tx.halt.part.prob = c(0.005, 0.004, 0.002),
